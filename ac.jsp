...
<html>
	<head>
		<title>ASAP - Account/Commerce</title>
		<meta charset="utf-8" />
            ...
            <!-- Now connect -->
                ...
                <%
                    ...
                    String query = "select b.img_title as Title, b.img_id as ID, b.img_author as Author, b.img_price as Price, b1.img_data as Pic from uploadedbooks b "+
                                    "inner join AC b1 on b.img_id= b1.img_id";
                    ...
                    pw.println("<tr><th>Book Name</th><th>Author name</th><th>Price</th></tr>");
                        while(rs.previous()) {
                            ...
                            pw.println("<tr>");
                            pw.println("<td><a href=\"showAC.jsp?bname="+nameB+"&idB="+id1+"\" style=\"padding: 2px;\">"+nameB+"</a></td>");
