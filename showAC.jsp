...
<html>
    <head>
        ...
        <title>ASAP - Accounts/Commerce</title>
		<meta charset="utf-8" />
						...
						<h2>Click on buy button to buy the book...</h2>
                                ...
                                <div>
                                    ...
                                    <div  style="max-height: 50px; max-width: 250px;">
                                        <a href="#"><img src="AC/<%=request.getParameter("bname")%>.jpg" height="320px" width="250px;"/></a>                            
                                    ...
                                    <div style="max-height: 850px; max-width: 850px; margin-left: 400px;">
                                        ...
                                        <div>
                                            <a href="Success.jsp?price="<%=request.getAttribute("pp")%>><img src="buynow.png" style="max-width: 200px; max-height: 200px; margin-left: 600px;"></a>
                                        </div>
                                        </div>
