						...
						<h2>Click on buy button to buy the book...</h2>
                                ...
                                <div>
                                    ...
                                    <div  style="max-height: 50px; max-width: 250px;">
                                        <a href="#"><img src="<%=request.getAttribute("Tag") %>/<%=request.getAttribute("Name")%>.jpg" height="320px" width="250px;"/></a>                            
                                        <p style="color: black; font-size: 20px; margin-left: 45px;"><%= request.getAttribute("Name").toString().toUpperCase()  %></p>
                                    </div>
                                    <div style="max-height: 850px; max-width: 850px; margin-left: 400px;">
                                        <p style="color: blue; font-size: 30px;">Description:</p>
                                        <div>
                                        <p style="color: black; margin-left: 50px;"><%=request.getAttribute("Desc")%></p>
                                        </div>  
                                    </div>
                                        <div style="margin-left: 400px;">
                                            <p style="color: blue; font-size: 30px;">Price:</p>
                                            <p style="color: green; font-size: 20px; margin-left: 50px;">Rs. <%=request.getAttribute("Price")%> </p>
                                        </div>
                                        <div style="margin-left: 400px;">
                                        ...
                                        <div>
                                            <a href="Success.jsp?price="<%=request.getAttribute("Price")%>><img src="buynow.png" style="max-width: 200px; max-height: 200px; margin-left: 600px;"></a>
                                        </div>
                                        </div>
